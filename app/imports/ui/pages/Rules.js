      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <p>While intending to keep the game fun, we will abide by
            the <a href="http://www.foosball.com/content.php?page=90" target="_blank">United
            States Table Soccer Association Rules of Play</a>.</p>

          <h4>About Rankings</h4>
          <p>The calculations for rankings is based on
            the <a href="http://www.bonziniusa.com/foosball/tournament/TournamentRankingSystem.html" target="_blank">Bonzini
          ...
          <dl>
            ...
            <dd>(1000-1499 Points, Initial Rating = 1250): Has the skills to be
              ...
              Expert-Elite and Master rated players). Is good by ordinary standards, but
              not likely to win many matches in major tournament open division events.</dd>
